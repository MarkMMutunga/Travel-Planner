          ...
          <div className="flex items-center space-x-4">
            <div className="flex-1">
              ...
              <input
                ...
                className="w-full px-4 py-3 border border-gray-300 rounded-lg text-lg focus:ring-2 focus:ring-green-500 focus:border-transparent transition duration-200"
              />
            </div>
            <button
              type="submit"
